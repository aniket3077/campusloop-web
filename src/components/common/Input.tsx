      ...
      <div className="w-full">
        ...
        <div className="relative rounded-lg shadow-subtle">
          ...
          <input
            id={inputId}
            ref={ref}
            className={`w-full rounded-lg border text-sm transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-0 disabled:bg-slate-50 disabled:text-slate-400 ${
